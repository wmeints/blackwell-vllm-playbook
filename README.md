...
- **Ansible** — installed locally on the machine (see [installation docs](https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html))
- **uv** — used to manage the Python environment and vLLM installation (see [uv installation](https://docs.astral.sh/uv/getting-started/installation/))
...
1. **Installs vLLM** — sets up a Python environment using uv and installs vLLM with its dependencies
2. **Configures a systemd service** — runs vLLM as a managed service with automatic restarts and log management, exposing an OpenAI-compatible API
